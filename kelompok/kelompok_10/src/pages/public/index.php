    ...
    <body>
        ...
        <section class="hero">
            <div class="hero-background">
                <svg class="laundry-item" width="84" height="84" viewBox="0 0 64 64" fill="none" xmlns="http:
                ...
                <svg class="laundry-item" width="72" height="72" viewBox="0 0 64 64" fill="none" xmlns="http:
                ...
                <svg class="laundry-item" width="56" height="80" viewBox="0 0 64 96" fill="none" xmlns="http:
                ...
                <svg class="laundry-item" width="70" height="56" viewBox="0 0 72 58" fill="none" xmlns="http:
                ...
                <svg class="laundry-item" width="64" height="72" viewBox="0 0 64 80" fill="none" xmlns="http:
                ...
                <svg class="laundry-item" width="56" height="76" viewBox="0 0 64 88" fill="none" xmlns="http:
                ...
                <svg class="laundry-item" width="64" height="56" viewBox="0 0 64 56" fill="none" xmlns="http:
...
<section class="features" id="layanan">
    <div class="feature-card">
        <div class="feature-icon">
            <svg width="80" height="80" viewBox="0 0 100 100" xmlns="http:
